...
public class CodeGenerator {
     ...
     * 数据库连接字符
     */
    private static final String URL = "jdbc:mysql://localhost:3306/youlai_system?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai";

    /**
     * 示例：private static final String PARENT_PACKAGE_NAME = "com.example.mybatisplusdemo";
     */
    private static final String PARENT_PACKAGE_NAME = "com.youlai.system";
...
//        completeGenerator();
    ...
    protected static void simpleGenerator() {
        ...
        String tables = "sys_pkg,sys_pkg_detail";
        String moduleName = "";
